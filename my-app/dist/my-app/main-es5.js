...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppHomeCellPhoneImageCellPhoneImageComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CellPhoneImageComponent = /*#__PURE__*/function () {
  ...
  function srcAppHomeCountdownTimerCountdownTimerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CountdownTimerComponent = /*#__PURE__*/function () {
      function CountdownTimerComponent() {
        ...
        this.countDown = new Date('Feb 14, 2021 12:00:00').getTime();
        this.timer = '';
  ...
  function srcAppPhoneDataTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var phones = {
      'phones': [{
        phoneName: 'iPhone 8+',
        repairPrice: "Repair Price - US $".concat(74.99),
        ...
        phoneName: 'iPhone 8',
        repairPrice: "Repair Price - US $".concat(69.99),
        ...
        phoneName: 'iPhone 6s+',
        repairPrice: "Repair Price - US $".concat(64.99),
        ...
        phoneName: 'iPhone 6s',
        repairPrice: "Repair Price - US $".concat(59.99),
        ...
        phoneName: 'iPhone 6',
        repairPrice: "Repair Price - US $".concat(54.99),
        oldRepairPrice: "Repair Price - US $".concat(70.00),
        src: 'url(https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/image/AppleInc/aos/published/images/i/ph/iphone7/plus/iphone7-plus-gold-select-2016?wid=513&hei=556&fmt=jpeg&qlt=95&op_usm=0.5,0.5&.v=1472430108712)'
      }, {
        phoneName: 'iPhone SE',
        repairPrice: "Repair Price - US $".concat(39.99),
        ...
        repairPrice: "Repair Price - US $".concat(134.99),
        ...
        repairPrice: "Repair Price - US $".concat(184.99),
